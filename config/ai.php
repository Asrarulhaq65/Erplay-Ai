    ...
    */
    ...
    'providers' => [
        ...
        'gemini' => [
            ...
            'models' => [
                'text' => ['default' => env('GEMINI_MODEL', 'gemini-2.0-flash')],
                'vision' => ['default' => env('GEMINI_MODEL', 'gemini-2.0-flash')],
            ],
        ],
        ...
        'byok-openai' => [
            ...
            'key' => null,
            'url' => env('OPENAI_COMPATIBLE_URL', 'https://api.openai.com/v1'),
            'models' => [
                'text' => ['default' => env('OPENAI_COMPATIBLE_MODEL', 'gpt-4o-mini')],
            ],
        ],
